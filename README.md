...
The `raycast/` directory has scripts for shortening DOIs, fetching BibTeX from a DOI, stripping tracking parameters off a URL, converting Markdown to RTF, and bolding clipboard text with Unicode. They're macOS only. See [raycast/README.md](raycast/README.md) for setup.
